...
use frame_support::{
    ...
    traits::{ConstU32, Currency, EnsureOneOf, EqualPrivilegeOnly, Imbalance, OnUnbalanced},
    weights::{
...
parameter_types! {
    ...
    pub const SessionOffset: BlockNumber = 1 * HOURS;
}
...
parameter_types! {
    ...
    // BagsList allows a practically unbounded count of nominators to participate in NPoS election
...
parameter_types! {
    ...
    pub const ProposalBondMinimum: Balance = 1_000 * MITO;
    pub const SpendPeriod: BlockNumber = 36 * DAYS;
