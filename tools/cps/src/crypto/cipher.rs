...
#[cfg(test)]
mod cipher_tests {
    //! Comprehensive test suite for Cipher module.
    //! 
    ...
    fn test_cipher_creation() {
        ...
        assert_eq!(cipher.algorithm(), crate::crypto::EncryptionAlgorithm::XChaCha20Poly1305);
        assert_eq!(cipher.scheme(), crate::crypto::CryptoScheme::Sr25519);
    }
