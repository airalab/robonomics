...
[source, shell]
----
cargo install --release frame-omni-bencher
----

 . Build the runtime with benchmarking features enabled:
+
[source, shell]
----
./scripts/build-runtime.sh --features=runtime-benchmarks
----
