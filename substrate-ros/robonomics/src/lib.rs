...
use msgs::{std_msgs, substrate_ros_msgs};
...
fn liability_stream(
    stream: mpsc::UnboundedReceiver<substrate_ros_msgs::Liability>,
    ros_account: String,
...
fn event_stream<B, C>(
    client: Arc<C>,
    liability_tx: mpsc::UnboundedSender<substrate_ros_msgs::Liability>,
) -> impl Future<Item=(),Error=()> where
