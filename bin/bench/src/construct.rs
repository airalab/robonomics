...
pub struct PoolTransaction {
    ...
    hash: robonomics_primitives::Hash,
}
...
impl From<OpaqueExtrinsic> for PoolTransaction {
    fn from(e: OpaqueExtrinsic) -> Self {
        PoolTransaction {
            data: e,
            hash: robonomics_primitives::Hash::zero(),
        }
    }
}
...
impl sp_transaction_pool::InPoolTransaction for PoolTransaction {
    ...
    type Hash = robonomics_primitives::Hash;
...
impl sp_transaction_pool::TransactionPool for Transactions {
    ...
    ) -> PoolFuture<Vec<Result<robonomics_primitives::Hash, Self::Error>>, Self::Error> {
        unimplemented!()
    }
